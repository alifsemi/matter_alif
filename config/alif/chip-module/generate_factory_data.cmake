...
# Generate a single factory data structure by Kconfig
#
# This function creates a list of arguments for external test script and then run it to generate a factory data files.
# This script request to build matter host and chip tool before use.
# Data generate needs following matter Host tools:
#   * spake2p
#   * chip-cert
#   * chip-tools
#
...
function(alif_create_factory_data_json factory_data_target script_path output_path)
...
# find chip cert tool
find_program(chip_cert_exe NAMES chip-cert PATHS ${CHIP_ROOT}/out/host REQUIRED)
...
find_program(chip_tool_exe NAMES chip-tool PATHS ${CHIP_ROOT}/out/host REQUIRED)
...
find_program(spake_exe NAMES spake2p PATHS ${CHIP_ROOT}/out/host REQUIRED)
...
add_custom_command(
    ...
    COMMENT "Generating Factory Data..."
    )
...
function(alif_generate_factory_data)
...
set(FACTORY_DATA_SCRIPT_PATH ${CHIP_ROOT}/scripts/tools/alif/factorydata_gen.py)
set(OUTPUT_FILE_PATH ${APPLICATION_BINARY_DIR}/zephyr)

# create a binary file with all factory data and generate header file
alif_create_factory_data_json(factory_data
